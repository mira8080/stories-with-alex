...
export default function App() {
  ...
  const categories = useMemo(() => [
    { emoji: "🐩", label: "Luna", color: "#FF6B8A", prompt: "Tell me a story where Luna, my french poodle, is the main character. Luna is playful, fluffy, white and very sweet." },
    { emoji: "🚀", label: "Space", color: "#7C6BFF", prompt: "Tell me an adventure story in outer space with planets, stars and friendly aliens." },
    { emoji: "🧚", label: "Fairies", color: "#FF7EB3", prompt: "Tell me a fairy tale with magic and an enchanted forest." },
    { emoji: "🦕", label: "Dinos", color: "#56C596", prompt: "Tell me a story with friendly and funny dinosaurs." },
    { emoji: "🧜‍♀️", label: "Mermaids", color: "#00C9DB", prompt: "Tell me an ocean story with mermaids and colorful fish." },
    { emoji: "🏰", label: "Castle", color: "#FFB347", prompt: "Tell me a story about a magical castle with friendly dragons." },
  ], []);
  ...
  const startCall = useCallback(async (storyPrompt) => {
    ...
    if (IS_DEMO) {
      setError("VAPI keys not found. Please add them to your .env file and restart the app.");
    ...
    try {
      ...
      console.error("VAPI Error:", err);
      setError("Could not connect to Alex. Please check your internet and try again!");
      setTimeout(() => setScreen("home"), 3000);
    }
  }, []);
      ...
      <div style={page}>
        ...
        <div style={safe}>
          <div style={{ textAlign: "center", animation: "fadeDown 0.8s both" }}>
            ...
            <h1 style={{ ...titleStyle(), margin: "0.5rem 0 0" }}>Stories with Alex</h1>
            <p style={{ ...subtitleStyle, margin: "0.35rem 0 0" }}>
              Pick a magical adventure or make your own! ✨
            </p>
            {IS_DEMO && (
              <p style={{ fontSize: "0.65rem", color: "#FF6B8A", marginTop: "0.4rem", padding: "0.3rem 0.8rem", background: "rgba(255,107,138,0.1)", borderRadius: "0.6rem", display: "inline-block" }}>
                ⚠️ Add VAPI keys to .env file to enable voice
              </p>
            )}
          </div>
          ...
          {!showCustom ? (
            <button onClick={() => setShowCustom(true)} style={{
              ...
              <div style={{ textAlign: "left", flex: 1 }}>
                <div style={{ fontSize: "clamp(0.95rem, 3.5vw, 1.1rem)", fontWeight: 700, color: "#FFE066" }}>Create your own story!</div>
                <div style={{ fontSize: "clamp(0.7rem, 2.5vw, 0.8rem)", color: "#ffffff66", fontWeight: 500, marginTop: 2 }}>Ask for any tale you can imagine</div>
              </div>
            ...
            <div style={{
              ...
              <div style={{ display: "flex", gap: "0.6rem" }}>
                <input type="text" value={customText}
                  ...
                  placeholder="e.g. Luna goes to the moon..."
                  autoFocus
              ...
              <div style={{ display: "flex", gap: "0.4rem", marginTop: "0.75rem", flexWrap: "wrap" }}>
                {["Luna in space 🚀", "Luna & the dragon 🐉", "Luna in the snow ❄️", "Luna finds treasure 💎"].map(s => (
    ...
    return (
      <div style={page}>
        ...
        <div style={{ ...safe, justifyContent: "center", alignItems: "center", textAlign: "center" }}>
          ...
          <h2 style={titleStyle("clamp(1.3rem, 5vw, 1.7rem)")}>Calling Alex...</h2>
          <p style={subtitleStyle}>Getting your magical story ready ✨</p>
          {error && (
    ...
    return (
      <div style={page}>
        ...
        <div style={{ ...safe, justifyContent: "center", alignItems: "center", textAlign: "center" }}>
          ...
          <h2 style={titleStyle("clamp(1.1rem, 4.5vw, 1.4rem)")}>Alex is telling your story... 📖</h2>
